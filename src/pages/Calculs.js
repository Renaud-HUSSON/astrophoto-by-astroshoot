...
const Calcul = () => {
  ...
  return <motion.div variants={pageTransition} animate="visible" initial="hidden" exit="exit" className="calcul-container">
    ...
    <div className="calcul-write">
      ...
      <div className="input-container">
        <label htmlFor="D">Diamètre du télescope:</label><br/>
        <input id="D" type="number" onChange={(e) => setD(e.target.value)} value={D}/>
      </div>
      <div className="input-container">
        <label htmlFor="Cd">Champ apparent de l'oculaire en degrés:</label><br/>
      ...
      <div className="input-container">
        <label htmlFor="brl">Multiplicateur de la barlow (1 si pas de barlow):</label><br/>
        <input id="brl" type="number" onChange={(e) => setbrl(e.target.value)} value={brl}/>
      </div>
      <div className="input-container">
        <label htmlFor="tp">Taille des pixels en microns:</label><br/>
        <input id="tp" type="number" onChange={(e) => settp(e.target.value)} value={tp}/>
      </div>
      <div className="input-container">
        <label htmlFor="nbpx">Nombres de pixels sur l'axe x:</label><br/>
        <input id="nbpx" type="number" onChange={(e) => setnbpx(e.target.value)} value={nbpx}/>
      </div>
      <div className="input-container">
        <label htmlFor="nbpy">Nombres de pixels sur l'axe y:</label><br/>
    ...
    <div className="calcul-read">
      ...
      <div className="input-container">
        ...
        <input onChange={() => {}} readOnly="" type="text" value={Math.round(LF * brl/D*10)/10}/>
      </div>
      <div className="input-container">
      ...
      <div className="input-container">
        ...
        <input onChange={() => {}} readOnly="" type="text" value={Math.round(Cd/(LF * brl/lf)*60*10)/10}/>
      </div>
      <div className="input-container">
        <label htmlFor="">Grossissement à l'oculaire:</label><br/>
        <input onChange={() => {}} readOnly="" type="text" value={Math.round(LF * brl/lf*10)/10}/>
      </div>
      <div className="input-container">
      ...
      <div className="input-container">
        ...
        <input onChange={() => {}} readOnly="" type="text" value={Math.round(D/(LF * brl/lf)*10)/10}/>
      </div>
      <div className="input-container">
        <label htmlFor="">Échantillonnage:</label><br/>
        <input onChange={() => {}} readOnly="" type="text" value={Math.round(206*tp/LF * brl*100)/100}/>
      </div>
      <div className="input-container">
      ...
      <div className="input-container">
        ...
        <input onChange={() => {}} readOnly="" type="text" value="Entre 1 et 3 secondes d'arc"/>
      </div>
      <div className="input-container">
        <label htmlFor="">Champ de vision couvert par la caméra en minutes d'arc:</label><br/>
        <input onChange={() => {}} readOnly="" type="text" value={Math.round(2*Math.atan((nbpx*tp/1000)/(2*LF * brl))*(180/Math.PI)*60*10)/10 + " par " + Math.round(2*Math.atan((nbpy*tp/1000)/(2*LF * brl))*(180/Math.PI)*60*10)/10}/>
      </div>
    </div>
  </motion.div>
}
